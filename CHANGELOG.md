...
## [0.13.0](https://github.com/Deepakanandrao/nextcrm-app/compare/v0.12.3...v0.13.0) (2026-06-13)


### Features

* add currency conversion library with unit tests ([b2eb41c](https://github.com/Deepakanandrao/nextcrm-app/commit/b2eb41cdea7381c3aa513b785ef22a4410b8de90))
* add CurrencyProvider context and header CurrencySwitcher ([4851c56](https://github.com/Deepakanandrao/nextcrm-app/commit/4851c562ee47116890bd414448ee2ecfa55f0b7f))
...
* **admin:** add currencies management page with table, rates, and ECB toggle ([6011159](https://github.com/Deepakanandrao/nextcrm-app/commit/60111591311e525f2d5857f73ce40cd9e7aca231))
...
* **auth:** add better-auth client with email OTP and admin plugins ([d605f28](https://github.com/Deepakanandrao/nextcrm-app/commit/d605f287e49f5b57995acef9055e4bb85b67eb54))
* **auth:** add RBAC permission definitions for admin/member/viewer ([a2ace92](https://github.com/Deepakanandrao/nextcrm-app/commit/a2ace92e9e35afa450960ed187f37a1e38f49e91))
* **auth:** add server-side getSession helper ([57562a4](https://github.com/Deepakanandrao/nextcrm-app/commit/57562a4e73768c8de7ad74b4ccba4371ada09ce5))
* **auth:** replace next-auth with better-auth ([eccad80](https://github.com/Deepakanandrao/nextcrm-app/commit/eccad80d733c50ca62cdaf4cf7493470225ba346))
* **auth:** replace NextAuth route handler with better-auth catch-all ([f4433a5](https://github.com/Deepakanandrao/nextcrm-app/commit/f4433a5437bf7d2fe71bdbd6bf1ac6a0b78ab446))
* **auth:** rewrite auth config with better-auth, Google OAuth, email OTP, RBAC ([94e6f3a](https://github.com/Deepakanandrao/nextcrm-app/commit/94e6f3a68cfc2d4cdc209e7c46651f6bb6725343))
* **auth:** rewrite login page with Google OAuth + Email OTP ([1eb6635](https://github.com/Deepakanandrao/nextcrm-app/commit/1eb663503e1264c6a755ca637d14f5a513b5c8b0))
* **auth:** update admin UI and replace all isAdmin/is_admin with role-based checks ([5956a66](https://github.com/Deepakanandrao/nextcrm-app/commit/5956a6618ab125aeae3039c147c9599919bb8c3a))
* **auth:** update proxy.ts from next-auth JWT to better-auth cookie check ([99e0c4c](https://github.com/Deepakanandrao/nextcrm-app/commit/99e0c4c2a69c542f9e36f7de0c73d0be01fc6403))
...
* **contracts:** add currency and snapshot rate to create/update actions ([1a6a4c8](https://github.com/Deepakanandrao/nextcrm-app/commit/1a6a4c8010f7561985e2b865c20bae5d77e81082))
* **contracts:** add currency dropdown to create/update forms ([f0e961d](https://github.com/Deepakanandrao/nextcrm-app/commit/f0e961d184c98acb39b4edb2d598e2e78ea651d7))
* **contracts:** display contract value with dynamic currency formatting ([d2c7308](https://github.com/Deepakanandrao/nextcrm-app/commit/d2c7308d76ae70d6f5838bf33474d2bfb1f59b38))
* convert opportunity detail budget to display currency ([aa82933](https://github.com/Deepakanandrao/nextcrm-app/commit/aa82933d27d3b5a960232c679f98fe451947786a))
* convert opportunity table budget to display currency ([030ca11](https://github.com/Deepakanandrao/nextcrm-app/commit/030ca11feb1427455d33d1143b8ab1bf7cbb1e36))
* convert reports dashboard KPIs to display currency ([a564588](https://github.com/Deepakanandrao/nextcrm-app/commit/a5645887b2f4ec14ee4db19a62bde43c25a85295))
...
* **dashboard:** display expected revenue in selected display currency ([7a2fa8f](https://github.com/Deepakanandrao/nextcrm-app/commit/7a2fa8fece3fc5a10b35eabc1ebcf5b4dce2a9ff))
* **db:** add better-auth session/account/verification tables and role column ([f1b9412](https://github.com/Deepakanandrao/nextcrm-app/commit/f1b9412b12c736f869ab67a46dc59e064263f660))
...
* **documents:** add batch actions bar for bulk delete, type change, and account linking ([7ed7cfa](https://github.com/Deepakanandrao/nextcrm-app/commit/7ed7cfa0ef97bd7281605a390a7b212fc3aa1324))
* **documents:** add bulk actions, versioning, and account linking server actions ([6a8908a](https://github.com/Deepakanandrao/nextcrm-app/commit/6a8908a39580f20e99e232fc03f944d381b1265f))
* **documents:** add document detail panel with summary, metadata, and version history ([9fd00f1](https://github.com/Deepakanandrao/nextcrm-app/commit/9fd00f1a0785e7715aaf4e4e6c70457e7256efee))
* **documents:** add enrichment fields, chunks table, and embeddings model ([c58a1e6](https://github.com/Deepakanandrao/nextcrm-app/commit/c58a1e657b23795504cdc9708682ab6e5d69178c))
* **documents:** add Inngest enrichment orchestrator with text extraction, embedding, summary, classification ([a7216cb](https://github.com/Deepakanandrao/nextcrm-app/commit/a7216cbb1a0a5370096560a5a513ec0e732b1743))
* **documents:** add name/content search toggle on documents page ([8043818](https://github.com/Deepakanandrao/nextcrm-app/commit/8043818bc1c2756ceb4cf7d3dd19f0fabe8de461))
* **documents:** add processing status badge component ([514fa69](https://github.com/Deepakanandrao/nextcrm-app/commit/514fa6963c9c4c7946bd4f08ac4d634110f68dc2))
* **documents:** add thumbnail generator and register Inngest functions ([b0b406e](https://github.com/Deepakanandrao/nextcrm-app/commit/b0b406ea4be6e75d865b0f85f1f21ccb5a693365))
* **documents:** add upload-from-account-context with auto-linking ([cb3a096](https://github.com/Deepakanandrao/nextcrm-app/commit/cb3a0963573e6ca5d38e4bb2d731b639dce09ee0))
* **documents:** redesign columns with type badges, summaries, status, and filters ([9ecd298](https://github.com/Deepakanandrao/nextcrm-app/commit/9ecd2984127f91fdcbe50616a5ae21afcf8eb64d))
* **documents:** replace 3 upload buttons with single bulk upload modal ([dde3a47](https://github.com/Deepakanandrao/nextcrm-app/commit/dde3a477e01ded54ba52953ed80da2baa8099e4e))
* **documents:** update createDocument with Inngest event, add checkDuplicate action ([90c2bbc](https://github.com/Deepakanandrao/nextcrm-app/commit/90c2bbc3021ba54eb3133a89fe6df9c9c8ecdfef))
* **documents:** update Zod schema and static filter data for enrichment fields ([4ce71b3](https://github.com/Deepakanandrao/nextcrm-app/commit/4ce71b37a63ab09999ba4d7283a8d1a4850fb6bc))
...
* **footer:** read app version from package.json ([0052e17](https://github.com/Deepakanandrao/nextcrm-app/commit/0052e17aadf5283299da88bc695c4b4124fa48fd))
* **footer:** read app version from package.json instead of env var ([003a728](https://github.com/Deepakanandrao/nextcrm-app/commit/003a728b56429230d40058622e7d0f6fb925e150))
* **inngest:** add daily ECB exchange rate sync function ([61e0819](https://github.com/Deepakanandrao/nextcrm-app/commit/61e08199f0bf783f7ebbb5230e298b8feafb0c56))
...
* **line-items:** add line items section to Contract detail page with copy-from-opportunity ([e3235fe](https://github.com/Deepakanandrao/nextcrm-app/commit/e3235fe0f8c4c1e468ed239668dcb1d60a46a1ac))
* **line-items:** add line items section to Opportunity detail page ([24436e1](https://github.com/Deepakanandrao/nextcrm-app/commit/24436e17a3d043ac1cefed2269cb6bebcf008323))
* **line-items:** add Prisma schema for Opportunity and Contract line items ([f3b1f30](https://github.com/Deepakanandrao/nextcrm-app/commit/f3b1f301e464760780dea6402192e71cbfb90de8))
* **line-items:** add server actions for Contract line items with copy-from-opportunity ([baa83d1](https://github.com/Deepakanandrao/nextcrm-app/commit/baa83d1b2bcc8401dd895f54c98402727ad8568b))
* **line-items:** add server actions for Opportunity line items ([680fa93](https://github.com/Deepakanandrao/nextcrm-app/commit/680fa93ef4d2631b7f71d035804f954966b629a9))
* **line-items:** add shared calculation helper ([825c733](https://github.com/Deepakanandrao/nextcrm-app/commit/825c7339302d995094ef595722f5c4f0718e6383))
* **line-items:** add shared LineItemsTable, AddLineItemForm, and EditLineItemForm components ([e839227](https://github.com/Deepakanandrao/nextcrm-app/commit/e839227a731660b4c1bd32d9c6206f6ac03c6543))
...
* **mcp:** accounts delete uses deletedAt instead of status ([f565523](https://github.com/Deepakanandrao/nextcrm-app/commit/f5655230775e703c0390811c0f9e7a4b77c2af25))
* **mcp:** add activities tools (5 tools, with entity links) ([7298d63](https://github.com/Deepakanandrao/nextcrm-app/commit/7298d632b1ed1f87e32a911b216bbbae60f93425))
* **mcp:** add barrel export and update route handler with new error codes ([bec7bbd](https://github.com/Deepakanandrao/nextcrm-app/commit/bec7bbd4a3eb832795c0485df508a1c88085cb4b))
* **mcp:** add campaigns tools (19 tools, full lifecycle + templates + steps + stats) ([7155053](https://github.com/Deepakanandrao/nextcrm-app/commit/7155053f44598eb5db45b5f4460a370578ee2bf7))
* **mcp:** add contracts tools (5 tools, with line items) ([79c3013](https://github.com/Deepakanandrao/nextcrm-app/commit/79c301311e0c1873941bb40d4af231aeec56e19a))
* **mcp:** add documents tools (8 tools, presigned URLs, entity linking) ([756d2be](https://github.com/Deepakanandrao/nextcrm-app/commit/756d2bea8630cbd1196df6e14884139fe22fa465))
* **mcp:** add enrichment tools (4 tools, single + bulk for contacts and targets) ([2067f21](https://github.com/Deepakanandrao/nextcrm-app/commit/2067f21ba57c61594cffa0ace229e3843a8bf9c4))
* **mcp:** add products tools (5 tools, org-wide catalog) ([7038bf2](https://github.com/Deepakanandrao/nextcrm-app/commit/7038bf2dac23b7a12ad23cc0213f2aeb49ba56f1))
* **mcp:** add projects tools (18 tools, boards/sections/tasks/comments/watchers) ([b40f3ae](https://github.com/Deepakanandrao/nextcrm-app/commit/b40f3ae572c61ad62de8b8c2ce0477535f2c6849))
* **mcp:** add reports tools (2) and email accounts tool (1) ([efe9cc7](https://github.com/Deepakanandrao/nextcrm-app/commit/efe9cc719ac15ed1f3d99f8496eee9e5bb39adf4))
* **mcp:** add shared helpers for pagination, search, soft-delete, errors ([a8a0eb0](https://github.com/Deepakanandrao/nextcrm-app/commit/a8a0eb0dd40375242c167c4f1a7f398286cfd683))
* **mcp:** add target lists tools (7 tools, membership management) ([4cdd748](https://github.com/Deepakanandrao/nextcrm-app/commit/4cdd748582733be4f63f7382a6717cfb70a0cf62))
* **mcp:** campaigns use deletedAt instead of status for soft-delete ([0fac95e](https://github.com/Deepakanandrao/nextcrm-app/commit/0fac95e803ff1bcd07a22e0af68e1da4ad76b8bd))
...
* **mcp:** enable board soft-delete, add deletedAt filters to board queries ([8973d34](https://github.com/Deepakanandrao/nextcrm-app/commit/8973d343ef5bc2bd7828f36b90fcf65f8cd2fabe))
...
* **mcp:** enable soft-delete for contacts, leads, targets, activities ([75217e4](https://github.com/Deepakanandrao/nextcrm-app/commit/75217e431146a4a6871f17445a67c178c0e01405))
* **mcp:** rename account tools with crm_ prefix, add soft-delete, use helpers ([288204b](https://github.com/Deepakanandrao/nextcrm-app/commit/288204bf7e870a7cc2b560c3994f7823ad311eb2))
* **mcp:** rename contacts/leads/opportunities/targets with crm_ prefix, add delete stubs ([24bfdcd](https://github.com/Deepakanandrao/nextcrm-app/commit/24bfdcd7bbebdb164a25305438f566557995bb9e))
...
* **mcp:** update helpers to use deletedAt-based soft delete ([41433ce](https://github.com/Deepakanandrao/nextcrm-app/commit/41433ce7d26ac6b2ae6a31b7865b3da9007539db))
* **migration:** add currency support migration ([86b7663](https://github.com/Deepakanandrao/nextcrm-app/commit/86b76636742c8bc4860de078f3731ac0e36886f9))
* **migration:** add idempotent role backfill script ([287b7fd](https://github.com/Deepakanandrao/nextcrm-app/commit/287b7fd7c3f1da1faf9629dcacb0ee97bb511673))
* multi-currency support for Sales module ([19848b0](https://github.com/Deepakanandrao/nextcrm-app/commit/19848b0b050cf7f76e1694cc1a608c1f7a558eb2))
* NextCRM v0.1.0 — better-auth, reports, activities, audit log, CRM settings, E2B enrichment ([f552f64](https://github.com/Deepakanandrao/nextcrm-app/commit/f552f64f39ba0bd0f0d5b00901023864c7d07afa))
* **opportunities:** add currency dropdown to create/update forms ([49cb1b7](https://github.com/Deepakanandrao/nextcrm-app/commit/49cb1b78e2595ee86651fe5ab6c0471856034d50))
* **opportunities:** add snapshot rate lookup on create/update ([f0f8380](https://github.com/Deepakanandrao/nextcrm-app/commit/f0f8380a2cc72cac4ede8304a737129ec4f93313))
* **opportunities:** display budget and revenue with currency formatting ([664c096](https://github.com/Deepakanandrao/nextcrm-app/commit/664c09645f9f161499e1e3486afda7b6700eeced))
* Products module, Line Items, and E2E test coverage ([cdb4498](https://github.com/Deepakanandrao/nextcrm-app/commit/cdb4498460b2081c8609370a79e19ae7e9d4f6fc))
* **products:** add create and update product form components ([98c4e60](https://github.com/Deepakanandrao/nextcrm-app/commit/98c4e60128ce5c983e48056197d6c69615d4ad56))
* **products:** add CSV bulk import server action ([3ed188a](https://github.com/Deepakanandrao/nextcrm-app/commit/3ed188aee12bc9d9b98b00b1c0481a0acb569888))
* **products:** add CSV import dialog with preview and template download ([c9b7388](https://github.com/Deepakanandrao/nextcrm-app/commit/c9b7388e0319c425716489a28a4a71bb1638a6dc))
* **products:** add Prisma schema for Products, ProductCategories, AccountProducts ([2c51b70](https://github.com/Deepakanandrao/nextcrm-app/commit/2c51b70350dcede4e3ef2ec4e64993477916f79c))
* **products:** add product categories to CRM data fetching ([eba0ea6](https://github.com/Deepakanandrao/nextcrm-app/commit/eba0ea653b3872c1288b8c1c40f83f7198e18d74))
* **products:** add product detail page with basic view, accounts tab, and history ([53d0d1f](https://github.com/Deepakanandrao/nextcrm-app/commit/53d0d1f3fb6be30b08b5487e8c5996e74893dbc6))
* **products:** add products list page and view component ([9b33aa7](https://github.com/Deepakanandrao/nextcrm-app/commit/9b33aa7440a4f7acb3a5eaba6d47f38b66d0a0fd))
* **products:** add server actions for Account-Product assignments ([ea3bc87](https://github.com/Deepakanandrao/nextcrm-app/commit/ea3bc8746f4fa3bd3225ed47818d345a8f8e4d4c))
* **products:** add server actions for Product CRUD and data fetching ([e84ea83](https://github.com/Deepakanandrao/nextcrm-app/commit/e84ea835663c59cef8021b86f3fd3afb9b64655b))
* **products:** add sidebar nav, account detail products tab with assign form ([3c1ab8b](https://github.com/Deepakanandrao/nextcrm-app/commit/3c1ab8b1ceec1616362676b1cf6de7968d5aeb22))
* **products:** add table components with columns, filters, and row actions ([7fe5c4c](https://github.com/Deepakanandrao/nextcrm-app/commit/7fe5c4ce5e1dfbfe196a55d2245e473952162ee4))
* **reports:** convert sales report values to display currency ([3784f7d](https://github.com/Deepakanandrao/nextcrm-app/commit/3784f7df9df29567cfe4a443f2fc9fdfefadd1d2))
...
* **schema:** add Currency, ExchangeRate, SystemSettings models and migrate money fields to Decimal ([bf3f16d](https://github.com/Deepakanandrao/nextcrm-app/commit/bf3f16d29532af16e8cd9dae46bb2d570fa6d0fd))
* **search:** add document search to command palette ([a0a5bbe](https://github.com/Deepakanandrao/nextcrm-app/commit/a0a5bbe064b358933f33fa8ad1b43c039c64659d))
* **search:** add documents to unified search with keyword + vector similarity ([299736f](https://github.com/Deepakanandrao/nextcrm-app/commit/299736fd74c539b65472db021cc8cfe0f1335abd))
...
* **seed:** add currency and exchange rate seed data ([3da4975](https://github.com/Deepakanandrao/nextcrm-app/commit/3da4975b75029a1b7134c875e8f6656849cd73df))
...
* add currency field to contracts table schema ([ed6a675](https://github.com/Deepakanandrao/nextcrm-app/commit/ed6a675648110d30aaf57920d9439c0f4c3f88fb))
* add currency to Opportunity schema type and fix implicit any ([a7ab752](https://github.com/Deepakanandrao/nextcrm-app/commit/a7ab752aa9c5879ee13600e7565852e0d251f2c6))
* add explicit types to currency map callbacks ([7d4d5a4](https://github.com/Deepakanandrao/nextcrm-app/commit/7d4d5a4912b285c7f84974fd08fadef3855c3aa1))
* add explicit types to currency map callbacks in layout ([33e74f4](https://github.com/Deepakanandrao/nextcrm-app/commit/33e74f44d2bf16a28a880986803e1247034e294d))
* add line items migration and resolve migration drift ([1b6f483](https://github.com/Deepakanandrao/nextcrm-app/commit/1b6f48392cf3801551ed918fd7b379aefe6b4513))
...
* **auth:** add modelName mapping for Users table and improve E2E auth setup ([150a6a1](https://github.com/Deepakanandrao/nextcrm-app/commit/150a6a1c7790534e3849f746e4e7ed8395cab05d))
...
* **auth:** fix all build errors — operator precedence, missing imports, type safety ([6466a6c](https://github.com/Deepakanandrao/nextcrm-app/commit/6466a6c004d3c6698580cba13733a34c653da0ec))
* **auth:** fix better-auth schema compatibility and E2E test infrastructure ([9560934](https://github.com/Deepakanandrao/nextcrm-app/commit/956093441c088303dd7270e0bfe82cff0bc9114d))
* **auth:** fix remaining next-auth imports and E2E test setup ([fb2a3e6](https://github.com/Deepakanandrao/nextcrm-app/commit/fb2a3e64201c98945684b8a47572beef6f39717d))
* **auth:** redirect to sign-in after signOut ([2e011c7](https://github.com/Deepakanandrao/nextcrm-app/commit/2e011c7ca221ddd732a2e2d451fedd01140c760c))
* **auth:** replace activate/deactivate admin with setUserRole in row actions ([161c41a](https://github.com/Deepakanandrao/nextcrm-app/commit/161c41ae5a4c0da5e1f6cf5efed08fa24bbb2543))
* **auth:** resolve Google OAuth user creation failures ([844389a](https://github.com/Deepakanandrao/nextcrm-app/commit/844389a689c0f20ab8d75bdf10648beeb829c5e3))
* **auth:** resolve Google OAuth user creation failures ([094e7ee](https://github.com/Deepakanandrao/nextcrm-app/commit/094e7ee715c034b7c023a574241871690cee68ad))
...
* **build:** resolve failed migration before deploy ([d063791](https://github.com/Deepakanandrao/nextcrm-app/commit/d0637914f2f296e079afd3fd280be204540c8b60))
...
* close pg pool on seed completion ([8193219](https://github.com/Deepakanandrao/nextcrm-app/commit/81932196b5988495e329313b01c2f2e8a50b3ca6))
...
* **crm:** guard assigned_to_user null in account BasicView ([fc28075](https://github.com/Deepakanandrao/nextcrm-app/commit/fc28075fc48bc4c51095bff7c55a3e1337188736))
...
* default accounts prop to empty array in UpdateContractForm ([3e21eac](https://github.com/Deepakanandrao/nextcrm-app/commit/3e21eac5fba06aed2e718964995a0b06f7f3ef50))
...
* **documents:** check upload response status in bulk upload modal ([d71dbf5](https://github.com/Deepakanandrao/nextcrm-app/commit/d71dbf52edb03144ba89f3b20e2dc5b4ef9deca1))
* **documents:** exclude pdf-parse and pdfjs-dist from Turbopack server bundle ([6ea7e4b](https://github.com/Deepakanandrao/nextcrm-app/commit/6ea7e4bec671046ea396e29930d132dcbe10d6f0))
...
* **documents:** replace next/image with img tag in DocumentViewModal ([3d2dafd](https://github.com/Deepakanandrao/nextcrm-app/commit/3d2dafdae168a2dccc6826d0b897a99351d0c901))
...
* **documents:** use pdf-parse v2 class-based API for text extraction ([2825f90](https://github.com/Deepakanandrao/nextcrm-app/commit/2825f90efc4f2cf97c65901f7c1f7d9f4125db25))
* **documents:** use row.original directly instead of Zod parse in row actions ([20a6016](https://github.com/Deepakanandrao/nextcrm-app/commit/20a601665e0e7b24b6a9555eeb298460c4468505))
* **e2e:** update home page test for OTP email auth flow ([33a6847](https://github.com/Deepakanandrao/nextcrm-app/commit/33a6847f5d8d46f8b95f776c21f9f7b7a078f0ac))
* guard FormSelect against undefined data and pass safe defaults ([91f1a45](https://github.com/Deepakanandrao/nextcrm-app/commit/91f1a457083794e2301dda4863376acbc37e7584))
* **inngest:** add gen_random_uuid() to embedding INSERT statements ([a6918b1](https://github.com/Deepakanandrao/nextcrm-app/commit/a6918b14e3dc3dcd4080a4d899bf95a26770bb1d))
...
* **line-items:** resolve build and type issues ([211ab7c](https://github.com/Deepakanandrao/nextcrm-app/commit/211ab7cf3cc496d08cc522c123323d9159426ecf))
* make FormSelect fully controlled to show defaultValue correctly ([0c926fc](https://github.com/Deepakanandrao/nextcrm-app/commit/0c926fc80a7851d780dd62611b3f63e3596d8d3f))
* **mcp:** add explicit ReportFilters type annotation to fix date type mismatch ([68414eb](https://github.com/Deepakanandrao/nextcrm-app/commit/68414eb4001ce2e0c35ea1e690db58c99960f510))
* **mcp:** fix campaign status filter collision and document unlink auth ([fc6f8a9](https://github.com/Deepakanandrao/nextcrm-app/commit/fc6f8a91a24098a21b1f1a9ad454fa7c14d6c0e4))
...
* **mcp:** prefix unused entity param in notFound helper ([e76305f](https://github.com/Deepakanandrao/nextcrm-app/commit/e76305f4ff439c27c76f1cfedff31ae1296ef405))
* **mcp:** remove isNotDeleted from opportunities (enum type mismatch), fix unused import in products ([3792d51](https://github.com/Deepakanandrao/nextcrm-app/commit/3792d515a0c05f97ea6f2c37749adcdafda8c3bc))
...
* **migration:** rename and make idempotent for failed deploy recovery ([3393859](https://github.com/Deepakanandrao/nextcrm-app/commit/339385928a7005ff36fbc6a3df64eaf678fa600b))
...
* **migration:** seed currencies and clean data before VARCHAR cast ([6ca3dcc](https://github.com/Deepakanandrao/nextcrm-app/commit/6ca3dccf08960b8cf6c2d1e83c8a8a2632acb75a))
...
* **products:** resolve audit log type errors and build issues ([784c444](https://github.com/Deepakanandrao/nextcrm-app/commit/784c444267f635594402f0528be6679e3e9d37d2))
...
* refactor UpdateContractForm to self-fetch accounts and currencies ([23e1dab](https://github.com/Deepakanandrao/nextcrm-app/commit/23e1dabcc8185deb0f93c161d08aa6347a972636))
* remove any casts from serializeDecimalsList call sites ([10a5fe9](https://github.com/Deepakanandrao/nextcrm-app/commit/10a5fe9e8d0530d8993d080cf5b78555840b4709))
* remove conflicting defaultValue from controlled FormDatePicker input ([326f995](https://github.com/Deepakanandrao/nextcrm-app/commit/326f995857da1294a86ebb45420c9affc0d579b5))
* replace getEnabledCurrencies with proper server action ([614162d](https://github.com/Deepakanandrao/nextcrm-app/commit/614162d9a2a70941cf6d338e5ad6c85243d04caf))
...
* resolve build errors - type casts and Inngest function signature ([0e3bf0f](https://github.com/Deepakanandrao/nextcrm-app/commit/0e3bf0f0ae5abed134d9319d460985c4dae7c782))
* resolve type issues in ECB sync function ([79b2663](https://github.com/Deepakanandrao/nextcrm-app/commit/79b266346fada836cb16c971224bc4a9ee502b9b))
* **schema:** add [@db](https://github.com/db).VarChar(3) to crm_Opportunities.currency field ([0ef0b8b](https://github.com/Deepakanandrao/nextcrm-app/commit/0ef0b8ba54251aed2900f8dc03558c315025869e))
...
* **security:** override defu&lt;=6.1.4 to 6.1.5 for prototype pollution CVE-2026-35209 ([507a866](https://github.com/Deepakanandrao/nextcrm-app/commit/507a866326a3920e04e38afefdc60bd4140f9de7))
* **security:** patch defu prototype pollution CVE-2026-35209 ([29d187d](https://github.com/Deepakanandrao/nextcrm-app/commit/29d187d2ab56fc7ec78913563864c2f7093c9c1b))
...
* serialize Decimal fields before passing to client components ([ff68db2](https://github.com/Deepakanandrao/nextcrm-app/commit/ff68db28f40b01111cf56ccd4b6d822f3e69cf24))
* serialize Decimal fields in getAllCrmData for client components ([8451299](https://github.com/Deepakanandrao/nextcrm-app/commit/845129965078a0260c7cdc2a82a5a326104e38f4))
* serialize opportunity Decimal fields before passing to client component ([bed1604](https://github.com/Deepakanandrao/nextcrm-app/commit/bed16042018525b18b9e2c59ace7f74568e1e574))
* split currency lib into client-safe and server-only modules ([1a61be3](https://github.com/Deepakanandrao/nextcrm-app/commit/1a61be3b404ce10b85e50769b76dba1a8037477c))
* stabilize flaky e2e tests across CRM modules ([dbb88b6](https://github.com/Deepakanandrao/nextcrm-app/commit/dbb88b69fbe5dd013d7ea61d0da0c72036fbe3b2))
...
* **tests:** update sales report tests for currency-aware aggregation ([c02d752](https://github.com/Deepakanandrao/nextcrm-app/commit/c02d7524a9636eb1ea2f2e81f27cb303833db81e))
* update @vercel/mcp-adapter to v1.0.0 and add to trusted builds ([e1583c2](https://github.com/Deepakanandrao/nextcrm-app/commit/e1583c2a7d87f6fc1790f0e0432d4812308988a7))
* wire currencies prop through opportunity and contract components ([dba0036](https://github.com/Deepakanandrao/nextcrm-app/commit/dba0036335819f598ec430f165cad8edf55b8213))
